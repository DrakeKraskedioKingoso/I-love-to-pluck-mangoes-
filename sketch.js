...
function setup() {
  ...
  mango4 = new mango(963, 201, 30)
  mango5 = new mango(1100, 158, 30)
  mango6 = new mango(1057, 209, 30)
  mango7 = new mango(1540, 66, 30)
  mango8 = new mango(1044, 75, 30)
  mango9 = new mango(1152, 221, 30)
